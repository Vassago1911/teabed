...
{
	if (region.bb.aC === region.bu.aC)
	{
		return 'on line ' + region.bb.aC;
	}
	return 'on lines ' + region.bb.aC + ' through ' + region.bu.aC;
}
...
var $author$project$GridFormat$is_level_string = function (try_str) {
	...
	var row_string = A2(
		...
		A2(
			$elm$core$Array$get,
			0,
			$elm$core$Array$fromList(ppieces)));
	var row_length_okay = !_Utils_eq(
		$elm$core$String$toInt(row_string),
		$elm$core$Maybe$Nothing);
	var lvl_string = A2(
		$elm$core$Maybe$withDefault,
		'',
		A2(
			...
			2,
			$elm$core$Array$fromList(ppieces)));
	var length_okay = $elm$core$List$length(pieces) === 3;
	var col_string = A2(
		$elm$core$Maybe$withDefault,
		'7',
		A2(
			...
			1,
			$elm$core$Array$fromList(ppieces)));
	var lvl_string_okay = _Utils_eq(
		$elm$core$String$length(lvl_string),
		A2(
			$elm$core$Maybe$withDefault,
			0,
			$elm$core$String$toInt(col_string)) * A2(
			$elm$core$Maybe$withDefault,
			0,
			$elm$core$String$toInt(row_string)));
	var col_length_okay = !_Utils_eq(
		$elm$core$String$toInt(col_string),
		$elm$core$Maybe$Nothing);
...
var $author$project$GridFormat$listed_local_cells_to_grid = function (l) {
	...
	var ll = A2(
		$elm$core$List$map,
		$elm$core$List$take(min_row_length),
		l);
	return {
		f: ll,
		y: $elm$core$List$length(l),
		L: min_row_length
	};
};
...
var $author$project$GridFormat$string_to_grid = function (raw_s) {
	...
	var s = A2(
		$elm$core$Maybe$withDefault,
		'',
		A2($elm$core$Array$get, 2, s_parts));
	var row_count = A2(
		$elm$core$Maybe$withDefault,
		0,
		$elm$core$String$toInt(
			A2(
				$elm$core$Maybe$withDefault,
				'0',
				A2($elm$core$Array$get, 0, s_parts))));
	var col_count = A2(
		$elm$core$Maybe$withDefault,
		0,
		$elm$core$String$toInt(
...
var $author$project$Main$KeyEventString = function (a) {
	return {$: 1, a: a};
};
var $author$project$Main$toKey = function (string) {
	...
	if ((!_v0.$) && (_v0.a.b === '')) {
		...
		return $author$project$Main$KeyEventString(string);
	}
};
...
var $robinheghan$murmur3$Murmur3$HashData = F4(
	function (shift, seed, hash, charsProcessed) {
		return {aa: charsProcessed, af: hash, U: seed, al: shift};
	});
...
var $robinheghan$murmur3$Murmur3$finalize = function (data) {
	var acc = (!(!data.af)) ? (data.U ^ A2(
		$robinheghan$murmur3$Murmur3$multiplyBy,
		$robinheghan$murmur3$Murmur3$c2,
		A2(
			$robinheghan$murmur3$Murmur3$rotlBy,
			15,
			A2($robinheghan$murmur3$Murmur3$multiplyBy, $robinheghan$murmur3$Murmur3$c1, data.af)))) : data.U;
	var h0 = acc ^ data.aa;
...
var $robinheghan$murmur3$Murmur3$hashFold = F2(
	function (c, data) {
		...
		if (_v0 === 24) {
			...
			return {aa: data.aa + 1, af: res, U: data.U, al: data.al + 8};
		}
	});
	...
	var s = $elm$core$String$fromList(
		A2(
			...
			A2(
				...
				$elm$core$List$concat(cell_grid.f))));
	var row_count = $elm$core$String$fromInt(
		$elm$core$List$length(cell_grid.f));
	var col_count = $elm$core$String$fromInt(
		$elm$core$List$length(
			A2(
				$elm$core$Maybe$withDefault,
				_List_Nil,
...
var $author$project$GridFormat$remove_column = function (grid) {
	...
	var new_rows = A2(
		$elm$core$List$map,
		$elm$core$List$take(new_col_count),
		grid.f);
	return {f: new_rows, y: new_col_count, L: grid.L};
};
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 0:
				var _char = msg.a;
				return (_char === 'q') ? _Utils_Tuple2(
					_Utils_update(
						model,
						{
							aA: A4($rtfeldman$elm_css$Css$rgba, 0, 255, 0, 0.3)
						}),
					$elm$core$Platform$Cmd$none) : _Utils_Tuple2(
					_Utils_update(
						model,
						{
							aA: A4($rtfeldman$elm_css$Css$rgba, 0, 0, 255, 0.3)
						}),
					$elm$core$Platform$Cmd$none);
			case 2:
				return _Utils_Tuple2(
...
var $author$project$Main$AddCol = {$: 3};
var $author$project$Main$AddRow = {$: 2};
var $author$project$Main$LevelToClipboard = {$: 6};
var $author$project$Main$RemCol = {$: 5};
var $author$project$Main$RemRow = {$: 4};
...
var $rtfeldman$elm_css$Css$Preprocess$Resolve$toStructure = function (_v0) {
	...
	var declarations = $rtfeldman$elm_css$Css$Preprocess$Resolve$extract(
		A2($elm$core$List$concatMap, $rtfeldman$elm_css$Css$Preprocess$unwrapSnippet, snippets));
	return {bq: charset, cb: declarations, bB: imports, bG: namespaces};
};
...
var $rtfeldman$elm_css$Css$Preprocess$stylesheet = function (snippets) {
	return {bq: $elm$core$Maybe$Nothing, bB: _List_Nil, bG: _List_Nil, bV: snippets};
};
...
var $rtfeldman$elm_css$Css$hidden = {o: 0, ak: 0, C: 'hidden', aL: 0};
...
var $rtfeldman$elm_css$Css$monospace = {N: 0, C: 'monospace'};
...
var $author$project$GridFormat$grid_to_list_of_stats = function (grid) {
	return A2(
		$elm$core$List$map,
		function (c) {
			return _Utils_Tuple3(c.bT, c.br, c.a3);
		},
...
var $author$project$Main$standard_svg_grid = function (model) {
	var r = F3(
		function (i, j, clr) {
			return A2(
				...
				_List_fromArray(
					[
						...
						$elm$core$String$fromInt(model.an)),
						$rtfeldman$elm_css$Svg$Styled$Attributes$fill(clr),
						$rtfeldman$elm_css$Svg$Styled$Attributes$strokeWidth('0.5'),
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$rtfeldman$elm_css$Css$fill(model.aA)
									])),
								$rtfeldman$elm_css$Css$active(
								_List_fromArray(
									[
										$rtfeldman$elm_css$Css$fill(
										$rtfeldman$elm_css$Css$hex('#001'))
									]))
							]))
					]),
				_List_Nil);
		});
	var list_of_cells = A2(
		$elm$core$List$map,
		function (_v1) {
			var a = _v1.a;
			var b = _v1.b;
	...
	var cells = A2(
		...
		function (_v0) {
			...
			var i = _v0.b;
			var clr = _v0.c;
			return A3(r, model.an * i, model.an * j, clr);
		},
		list_of_cells);
	return cells;
};
...
var $author$project$Main$svg_frame_attributes = _List_fromArray(
	[
		$rtfeldman$elm_css$Html$Styled$Attributes$css(
		_List_fromArray(
			[
		...
		$rtfeldman$elm_css$Svg$Styled$Attributes$width('100vw'),
		$rtfeldman$elm_css$Svg$Styled$Attributes$height('100vh'),
		$rtfeldman$elm_css$Svg$Styled$Attributes$viewBox('0 0 3840 2160')
	]);
...
var $author$project$Main$view = function (model) {
	var standard_css_header = _List_fromArray(
		[
				...
				[
					...
					_List_fromArray(
						[
							...
							$rtfeldman$elm_css$Css$vmin(2)),
							$rtfeldman$elm_css$Css$fontWeight(
							$rtfeldman$elm_css$Css$int(352)),
							$rtfeldman$elm_css$Css$color(
							A3($rtfeldman$elm_css$Css$rgb, 225, 225, 225)),
							$rtfeldman$elm_css$Css$overflow($rtfeldman$elm_css$Css$hidden)
						])),
			...
			_Utils_ap(
				...
				_List_fromArray(
					[
						...
						$author$project$Main$svg_frame_attributes,
						$author$project$Main$standard_svg_grid(model))
					])),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							$rtfeldman$elm_css$Html$Styled$text('Add/Remove Rows/Colums'),
							A2(
								...
								[
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													$rtfeldman$elm_css$Html$Styled$Events$onClick($author$project$Main$AddRow),
													$rtfeldman$elm_css$Html$Styled$Attributes$css(
													_List_fromArray(
														[
															$rtfeldman$elm_css$Css$hover(
											...
											_List_fromArray(
												[
													$rtfeldman$elm_css$Html$Styled$Events$onClick($author$project$Main$RemRow),
													$rtfeldman$elm_css$Html$Styled$Attributes$css(
													_List_fromArray(
														[
															$rtfeldman$elm_css$Css$hover(
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													$rtfeldman$elm_css$Html$Styled$Events$onClick($author$project$Main$AddCol),
													$rtfeldman$elm_css$Html$Styled$Attributes$css(
													_List_fromArray(
														[
															$rtfeldman$elm_css$Css$hover(
											...
											_List_fromArray(
												[
													$rtfeldman$elm_css$Html$Styled$text('C+')
												])),
											A2(
											$rtfeldman$elm_css$Html$Styled$td,
											_List_fromArray(
												[
													$rtfeldman$elm_css$Html$Styled$Events$onClick($author$project$Main$RemCol),
													$rtfeldman$elm_css$Html$Styled$Attributes$css(
													_List_fromArray(
														[
															$rtfeldman$elm_css$Css$hover(
							...
							_List_fromArray(
								[
									$rtfeldman$elm_css$Html$Styled$Events$onClick($author$project$Main$LevelToClipboard),
									$rtfeldman$elm_css$Html$Styled$Attributes$css(
									_List_fromArray(
										[
											$rtfeldman$elm_css$Css$backgroundColor(
											$rtfeldman$elm_css$Css$hex('#222')),
											A2($rtfeldman$elm_css$Css$property, 'word-wrap', 'break-word'),
											$rtfeldman$elm_css$Css$position($rtfeldman$elm_css$Css$absolute),
							...
							_List_fromArray(
								[
									$rtfeldman$elm_css$Html$Styled$text('click to clipboard')
								]))
						]))
				])));
};
